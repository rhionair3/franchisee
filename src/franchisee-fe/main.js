                ...
                <div className={stylesBrambang.root}>
                    ...
                    <Drawer className={classes.brambangDrawer} variant="persistent" open={open} classes={{ paper: classes.brambangDrawerPaper, }}>
                        ...
                        <List>
                            ...
                            <div className={classes.listItemWrapper}>
                                <ListItem className={classes.listItemInner} component="a" href="/franchisee">
                                        <ListItemIcon>
                                            <DashboardIcon />
                                        </ListItemIcon>
                            ...
                            <div className={classes.listItemWrapper}>
                                <ListItem className={classes.listItemInner} component="a" href="/sertifikat">
                                        <ListItemIcon>
                                            <DashboardIcon />
                                        </ListItemIcon>
                            ...
                            <div className={classes.headerSideBarMenu}>
                                <ListItem className={classes.headerSideBarMenuInner}>
                                        <ListItemText primary="Konfigurasi" color="inherit" />
                                </ListItem>
                            </div>
                            <div className={classes.listItemWrapper}>
                            ...
                            <div className={classes.listItemWrapper}>
                                <ListItem className={classes.listItemInner}  component="a" href="/master/employee">
                                        <ListItemIcon>
                                            <DashboardIcon />
                                        </ListItemIcon>
...
export default withStyles(stylesBrambang)(Layout);