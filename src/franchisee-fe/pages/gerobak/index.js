...
class Gerobak extends Component {
    render() {
              ...
              return (
                <TableRow className={classes.tableDetailWrapper}>
                    <TableCell colSpan={colSpan}>
                            <MUIDatatable title={"ACME Gerobak list"} data={data} columns={columns} options={options} />
                    </TableCell>
                </TableRow>
              );
            }
...
export default withStyles(stylesBrambang, { withTheme: true })(Gerobak);