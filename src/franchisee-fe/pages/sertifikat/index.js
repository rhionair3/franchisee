              ...
              return (
                <TableRow className={classes.tableDetailWrapper}>
                    <TableCell colSpan={colSpan}>
                            <MUIDatatable title={"ACME Sertifikat list"} data={data} columns={columns} options={options} />
                    </TableCell>
                </TableRow>
              );
            }
...
Sertifikat.propTypes = {
    classes: PropTypes.object.isRequired,
    theme: PropTypes.object.isRequired,
};

export default withStyles(stylesBrambang, { withTheme: true })(Sertifikat);